...
class MathQuestionServiceTest {
    public final MathQuestionRepository mathQuestionRepositoryMock = mock(MathQuestionRepository.class);
    public final MathQuestionService out = new MathQuestionService(mathQuestionRepositoryMock);
    ...
    void testAdd(Question[] questionForPrefilling, String question, String answer, Question expectedQuestion) {
        when(mathQuestionRepositoryMock.add(any())).thenReturn(expectedQuestion);
    ...
    void testRemove(Question[] questionForPrefilling, Question expectedQuestion) {
        when(mathQuestionRepositoryMock.remove(any())).thenReturn(expectedQuestion);
        for (Question s : questionForPrefilling) {
            out.add(s);
        }
    ...
    void testGetQuestions(Question[] questionForPrefilling, Set<Question> expectedSet) {
        when(mathQuestionRepositoryMock.getAll()).thenReturn(expectedSet);
        for (Question s : questionForPrefilling) {
            out.add(s);
        }
